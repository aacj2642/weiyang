  ...
  <div v-if="newsItem" class="news-detail-view container-fluid pt-5 mt-5">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-10">
          <!-- Back Button -->
          <button @click="$router.back()" class="btn btn-link text-white-50 text-decoration-none mb-4 p-0">
          ...
          <div class="news-header mb-5">
            ...
            <h1 class="display-5 fw-bold text-white letter-spacing-wide mb-4">{{ newsItem.title }}</h1>
            <div class="news-meta d-flex flex-wrap gap-4 text-white-50">
              <span><i class="bi bi-calendar3 me-2"></i> {{ newsItem.date }}</span>
              <span><i class="bi bi-clock me-2"></i> {{ newsItem.time }}</span>
              <span><i class="bi bi-geo-alt me-2"></i> {{ newsItem.location }}</span>
            </div>
          </div>
          ...
          <div class="row g-5">
            ...
            <div class="col-md-6">
              <div class="news-description text-white">
                <h4 class="fw-bold mb-4 border-start border-primary border-4 ps-3">詳細資訊</h4>
...
export default {
  ...
  setup() {
    ...
    const handleImageError = (e) => {
      e.target.src = "https://placehold.co/800x1200/222/555?text=Poster+Placeholder";
    };
